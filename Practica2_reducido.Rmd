...
Ideas: 
* Contraste de asesinatos/oro entre equipo ganador y perdedor. 
* Correlación de variables de equipos/jugadores con la victoria. 
* Regresión logística ganar
* Proporción de dragones que se lleva cada equipo es la misma (lado rojo/azul)
* Relación entre primera sangre y equipo ganador
...
Por otra parte se puede reformatear dataset y buscar el KDA de MID para el equipo que gana (azul si gana azul, rojo si gana rojo) generando la variable kda del mid ganador. Contrastar si cuando un equipo gana su KDA es superior. 
Contrastar si el KDA de los mid y los adc son diferentes. 
Contrastar con equipos
...
#### 4.3.2.4 Comprobación de diferencia de KDA entre posiciones (para el equipo ganador?)
